...
import static com.appdynamics.extensions.sql.Util.toBigIntString;
...
class MetricPrinter {
    ...
    void printMetric(String metricPath, BigDecimal metricValue, String aggType, String timeRollupType, String clusterRollupType) {
